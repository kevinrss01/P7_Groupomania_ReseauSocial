...
--
-- Temporary view structure for view `aliment_proteines_dec_vw`
--

DROP TABLE IF EXISTS `aliment_proteines_dec_vw`;
/*!50001 DROP VIEW IF EXISTS `aliment_proteines_dec_vw`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `aliment_proteines_dec_vw` AS SELECT 
 1 AS `id`,
 1 AS `nom`,
 1 AS `marque`,
 1 AS `sucre`,
...
INSERT INTO `langue` VALUES (1,'français'),(2,'anglais'),(3,'Français');
...
--
-- Final view structure for view `aliment_proteines_dec_vw`
--
...
/*!50001 VIEW `aliment_proteines_dec_vw` AS select `aliment`.`id` AS `id`,`aliment`.`nom` AS `nom`,`aliment`.`marque` AS `marque`,`aliment`.`sucre` AS `sucre`,`aliment`.`calories` AS `calories`,`aliment`.`graisses` AS `graisses`,`aliment`.`proteines` AS `proteines`,`aliment`.`bio` AS `bio` from `aliment` order by `aliment`.`proteines` desc */;
...
-- Dump completed on 2022-06-05 23:47:33
